...
cp dcom_qpe_log $COMOUT/${RUN}.${PDY}/qpe_log.prevhr
...
# toplot4.$date is made in scripts/expcpanl_stage4.sh, before calling
# ush/nam_pcpanl_st4mosaic.sh and nam_pcpanl_st4oconus.sh
